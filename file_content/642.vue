...
<demo-block>
        ...
        <!--element-demo: <el-form ref="form" :model="form" label-width="80px">
...
<demo-block>
        ...
        <!--element-demo: <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
...
<demo-block>
        ...
        <!--element-demo: <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
...
<demo-block>
        ...
        <!--element-demo: <el-form :model="dynamicValidateForm" ref="dynamicValidateForm" label-width="100px" class="demo-dynamic">
  <el-form-item
    prop="email"
    label="邮箱"
    :rules="[
...
<demo-block>
        ...
        <!--element-demo: <el-form ref="form" :model="sizeForm" label-width="80px" size="mini">
  <el-form-item label="活动名称">
