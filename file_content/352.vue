...
<p>Estandarizamos los bordes que se pueden utilizar en botones, tarjetas, pop-ups y otros componentes.</p>
<h3 id="border-2"><a class="header-anchor" href="#border-2">¶</a> Border</h3>
<p>Hay pocos estilos de borde para elegir.</p>
...
<p>Hay pocos estilos de radio para elegir.</p>
...
<h3 id="shadow"><a class="header-anchor" href="#shadow">¶</a> Shadow</h3>
<p>Hay pocos estilos de sombra para elegir.</p>
<div 
class="demo-shadow"
