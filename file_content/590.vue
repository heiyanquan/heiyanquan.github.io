...
<demo-block>
        ...
        <!--element-demo: <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
...
<demo-block>
        ...
        <!--element-demo: <el-radio-group v-model="isCollapse" style="margin-bottom: 20px;">
