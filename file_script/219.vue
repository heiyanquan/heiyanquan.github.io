    ...
    [
      [
        _c(
          ...
          [
            _c("el-table-column", {
              attrs: { fixed: "", prop: "date", label: "Date", width: "150" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
    ...
    [
      [
        _c(
          ...
          [
            _c("el-table-column", {
              attrs: { prop: "date", label: "Date", width: "150" }
            }),
            _vm._v(" "),
            _c(
              "el-table-column",
              { attrs: { label: "Delivery Info" } },
              [
                _c("el-table-column", {
                  attrs: { prop: "name", label: "Name", width: "120" }
                }),
      ...
      [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { property: "date", label: "Date", width: "120" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
        ...
        _c(
          ...
          [
            _c(
              ...
              [_vm._v("Toggle selection status of second and third rows")]
            ),
            _vm._v(" "),
            _c(
              "el-button",
    ...
    [
      [
        _c(
          ...
          [
            _c("el-table-column", {
              attrs: { prop: "date", label: "Date", sortable: "", width: "180" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "name", label: "Name", width: "180" }
              ...
              scopedSlots: _vm._u([
                {
                  ...
                  fn: function(props) {
                    return [
                      _c("p", [_vm._v("State: " + _vm._s(props.row.state))]),
                      _vm._v(" "),
                      _c("p", [_vm._v("City: " + _vm._s(props.row.city))]),
                      _vm._v(" "),
                      _c("p", [
                        _vm._v("Address: " + _vm._s(props.row.address))
                      ]),
                      _vm._v(" "),
                      _c("p", [_vm._v("Zip: " + _vm._s(props.row.zip))])
                    ]
                  }
                }
              ])
      ...
      [
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "amount1", label: "Cost 1 ($)" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "amount2", label: "Cost 2 ($)" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "amount3", label: "Cost 3 ($)" }
            })
          ],
          1
        )
          ...
          [
            ...
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "amount1", label: "Amount 1" }
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "amount2", label: "Amount 2" }
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "amount3", label: "Amount 3" }
                })
              ],
              1
            )
