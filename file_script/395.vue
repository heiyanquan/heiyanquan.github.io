    ...
    [
      [
        _c(
          ...
          [
            _c("el-table-column", {
              attrs: { fixed: "", prop: "date", label: "Fecha", width: "150" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "name", label: "Nombre", width: "120" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "state", label: "Estado", width: "120" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "city", label: "Ciudad", width: "120" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
            ...
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "zip", label: "Código postal", width: "120" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { fixed: "right", label: "Operaciones", width: "120" },
              scopedSlots: _vm._u([
                {
                  key: "default",
                  fn: function(scope) {
    ...
    [
      [
        _c(
          ...
          [
            _c("el-table-column", {
              attrs: { prop: "date", label: "Fecha", width: "150" }
            }),
            _vm._v(" "),
            _c(
              "el-table-column",
              { attrs: { label: "Información de entrega" } },
              [
                _c("el-table-column", {
                  attrs: { prop: "name", label: "Nombre", width: "120" }
                }),
                ...
                _c(
                  "el-table-column",
                  { attrs: { label: "Información de dirección" } },
                  [
                    _c("el-table-column", {
                      attrs: { prop: "state", label: "Estado", width: "120" }
                    }),
      ...
      [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { property: "date", label: "Fecha", width: "120" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
            ...
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { property: "address", label: "Dirección" }
            })
          ],
          1
        ),
        ...
        _c(
          ...
          [
            _c(
              ...
              [_vm._v("Seleccionar segunda fila")]
            ),
            _vm._v(" "),
            _c(
              "el-button",
                    ...
                    return [
                      _c(
                        "el-tag",
                        {
                          attrs: {
                            type:
                              scope.row.tag === "Home" ? "primary" : "success",
                            "disable-transitions": ""
                          }
                        },
                  ...
                  fn: function(scope) {
                    return [
                      _c(
                        ...
                        [
                          _c("p", [_vm._v("Name: " + _vm._s(scope.row.name))]),
                          _vm._v(" "),
                          _c("p", [
      ...
      [
        _c(
          ...
          [
              ...
              scopedSlots: _vm._u([
                {
                  ...
                  fn: function(props) {
                    return [
                      _c("p", [_vm._v("Estado: " + _vm._s(props.row.state))]),
                      _vm._v(" "),
                      _c("p", [_vm._v("Ciudad: " + _vm._s(props.row.city))]),
                      _vm._v(" "),
                      _c("p", [
                        _vm._v("Dirección: " + _vm._s(props.row.address))
                      ]),
                      _vm._v(" "),
                      _c("p", [
                        _vm._v("Código postal: " + _vm._s(props.row.zip))
                      ])
                    ]
                  }
                }
            ...
            _vm._v(" "),
            _c("el-table-column", { attrs: { label: "Fecha", prop: "date" } }),
            _vm._v(" "),
            _c("el-table-column", { attrs: { label: "Nombre", prop: "name" } })
          ],
          1
        )
      ]
      ...
      [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "amount1", sortable: "", label: "Monto 1" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "amount2", sortable: "", label: "Monto 2" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "amount3", sortable: "", label: "Monto 3" }
            })
          ],
          1
        ),
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "amount1", label: "Costo 1 ($)" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "amount2", label: "Costo 2 ($)" }
            }),
            _vm._v(" "),
            _c("el-table-column", {
              attrs: { prop: "amount3", label: "Costo 3 ($)" }
            })
          ],
          1
        )
          ...
          [
            ...
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "amount1", label: "Monto 1" }
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "amount2", label: "Monto 2" }
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "amount3", label: "Monto 3" }
                })
              ],
              1
            )
