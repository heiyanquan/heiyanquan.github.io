    ...
    [
      [
        ...
        _c(
          ...
          [
            _c("span", { staticClass: "demonstration" }, [
              _vm._v("Customized initial value")
            ]),
            _vm._v(" "),
            _c("el-slider", {
              model: {
        ...
        _c(
          ...
          { staticClass: "block" },
          [
            _c("span", { staticClass: "demonstration" }, [_vm._v("Disabled")]),
            _vm._v(" "),
            _c("el-slider", {
              attrs: { disabled: "" },
              model: {
    ...
    [
      [
        _c(
          ...
          [
            _c("span", { staticClass: "demonstration" }, [
              _vm._v("Breakpoints not displayed")
            ]),
            _vm._v(" "),
            _c("el-slider", {
              attrs: { step: 10 },
