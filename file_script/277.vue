...
render._withStripped = true
  ...
  return _c(
    ...
    [
      _c("el-input", {
        attrs: { placeholder: "Please input", disabled: true },
        model: {
          value: _vm.input,
          callback: function($$v) {
            _vm.input = $$v
...
render._withStripped = true
  ...
  return _c(
    ...
    [
      _c("el-input", {
        attrs: { placeholder: "Please input password", "show-password": "" },
        model: {
          value: _vm.input,
          callback: function($$v) {
            _vm.input = $$v
    ...
    _c(
      ...
      [
        _c("span", { staticClass: "demo-input-label" }, [
          _vm._v("Using attributes")
        ]),
        _vm._v(" "),
        _c("el-input", {
          attrs: { placeholder: "Pick a date", "suffix-icon": "el-icon-date" },
          model: {
            value: _vm.input1,
            callback: function($$v) {
              _vm.input1 = $$v
...
render._withStripped = true
  ...
  return _c(
    ...
    [
      _c("el-input", {
        attrs: { type: "textarea", autosize: "", placeholder: "Please input" },
        model: {
          value: _vm.textarea1,
          callback: function($$v) {
            _vm.textarea1 = $$v
        ...
        _c(
          ...
          [
            _c(
              ...
              [
                _c("el-option", { attrs: { label: "Restaurant", value: "1" } }),
                _vm._v(" "),
                _c("el-option", { attrs: { label: "Order No.", value: "2" } }),
                _vm._v(" "),
                _c("el-option", { attrs: { label: "Tel", value: "3" } })
              ],
              1
            ),
            _vm._v(" "),
  ...
  return _c("div", [
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("el-input", {
          attrs: { size: "medium", placeholder: "Please Input" },
          model: {
            value: _vm.input2,
            callback: function($$v) {
              _vm.input2 = $$v
        ...
        _vm._v(" "),
        _c("el-input", {
          attrs: { size: "small", placeholder: "Please Input" },
          model: {
            value: _vm.input3,
            callback: function($$v) {
              _vm.input3 = $$v
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("div", { staticClass: "sub-title" }, [
                _vm._v("list suggestions when activated")
              ]),
              _vm._v(" "),
              _c("el-autocomplete", {
          ...
          _c(
            ...
            [
              _c("div", { staticClass: "sub-title" }, [
                _vm._v("list suggestions on input")
              ]),
              _vm._v(" "),
              _c("el-autocomplete", {
                staticClass: "inline-input",
