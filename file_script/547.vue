...
render._withStripped = true
  ...
  return _c(
    ...
    [
      _c("el-tree", {
        attrs: { data: _vm.data, props: _vm.defaultProps, "show-checkbox": "" },
        on: { "check-change": _vm.handleCheckChange }
      })
    ],
    1
  ...
  return _c("div", [
    _c("div", { staticClass: "custom-tree-container" }, [
      _c(
        ...
        { staticClass: "block" },
        [
          _c("p", [_vm._v("Avec render-content")]),
          _vm._v(" "),
          _c("el-tree", {
            attrs: {
              data: _vm.data,
