...
<h2 id="couleur"><a class="header-anchor" href="#couleur">¶</a> Couleur</h2>
<p>Element utilise un ensemble de palettes spécifiques afin de fournir un style consistant pour vos produits.</p>
<h3 id="couleur-principale"><a class="header-anchor" href="#couleur-principale">¶</a> Couleur principale</h3>
<p>La couleur principale d'Element est un bleu clair et agréable.</p>
<el-row :gutter="12">
...
<h3 id="couleurs-secondaires"><a class="header-anchor" href="#couleurs-secondaires">¶</a> Couleurs secondaires</h3>
<p>En plus de la couleur principale, vous devrez sans doute utiliser d'autres couleurs pour différents cas de figures, par exemple une couleur de danger pour indiquer une opération dangereuse.</p>
<el-row :gutter="12">
...
<h3 id="couleurs-neutres"><a class="header-anchor" href="#couleurs-neutres">¶</a> Couleurs neutres</h3>
<p>Les couleurs neutres sont les couleurs du fond, du texte et des bordures. Vous pouvez utiliser différentes couleurs neutres pour représenter une structure hiérarchique.</p>
<el-row :gutter="12">
  <el-col :span="6" :xs="{span: 12}">
